  ...
  return (
    <div className="fixed inset-0 bg-black backdrop-blur-md bg-opacity-50 flex items-center justify-center z-[90]">
      <div className="bg-white p-6 rounded-lg shadow-lg w-11/12 md:w-[30%]">
        ...
        <p className="text-gray-500">
          <span className="font-medium">Reviews:</span> {product.ratingsAverage}{" "}
            ...
            {products.map((product, index) => (
              ...
              >
                ...
                <div className="px-4 py-4">
                  ...
                  <button className="block bg-[#2E982D] hover:bg-[#1e6a1e] shadow-[0px_0px_15px_5px_rgba(0,0,0,0.1);] transition duration-300 ease-in-out text-white w-[100%] text-[12px] md:text-[14px] mx-auto p-2 lg:p-[10px] mt-3 rounded font-medium">
                    Add to Cart
                  </button>
                  <p
